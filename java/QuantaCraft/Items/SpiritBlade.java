...
public class SpiritBlade extends ItemSword implements ISoulGatherer {

	public SpiritBlade(String name , ToolMaterial toolMat) {
		  super(toolMat);
	...
	public void onCreated(ItemStack stack, World world , EntityPlayer player){
	 ...
	 public static ItemStack addSouls(ItemStack stack , int souls){
		if (stack.stackTagCompound!=null){
			...
			return SoulHandler.setSouls(stack, souls);
		}
