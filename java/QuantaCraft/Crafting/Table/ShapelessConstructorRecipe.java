...
public class ShapelessConstructorRecipe extends ConstructorRecipeBase{

	public ShapelessConstructorRecipe(String recId, ItemStack stack,
	...
	public ShapelessConstructorRecipe(ItemStack stack,
			Knowledges knows, ItemStack[] ing) {
