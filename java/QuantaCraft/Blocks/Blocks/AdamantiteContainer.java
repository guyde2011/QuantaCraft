...
public class AdamantiteContainer extends BlockContainer{
	public TileEntityAdamantiteContainer hi;
    public AdamantiteContainer(int par1, String name, Material blockMaterial,float hardness) {
        super(blockMaterial);
    ...
    {
    	if (!world.isRemote) {
    		hi = (TileEntityAdamantiteContainer) world.getTileEntity(x, y, z);
    		player.openGui(modMain.instance, 0, world, x, y, z);
    		return true;
    	} else {
    		return false;
    	}
    ...
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntityAdamantiteContainer();    
    	return hi;
    }
