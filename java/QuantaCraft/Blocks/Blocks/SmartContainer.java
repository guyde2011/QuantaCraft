...
public class SmartContainer extends BlockContainer{
	public TileEntitySmartContainer hi;
    public SmartContainer(int par1, String name, Material blockMaterial,float hardness) {
        super(blockMaterial);
    ...
    {
    	if (!world.isRemote) {
    		hi = (TileEntitySmartContainer) world.getTileEntity(x, y, z);
    		player.openGui(modMain.instance, 8, world, x, y, z);
    		return true;
    	} else {
    		return false;
    	}
    ...
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntitySmartContainer();    
    	return hi;
    }
   ...
   public void registerBlockIcons(IIconRegister icon) {
	   topIcon = icon.registerIcon(modMain.modid.toLowerCase() + ":" + this.getUnlocalizedName().substring(5));
	   bottomIcon = topIcon;
	   sideIcon = topIcon;
	   frontIcon = topIcon;
   }
