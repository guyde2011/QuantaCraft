...
public class ItemsInvCableBlock extends BlockContainer implements ICable{
	...
	public ItemsInvCableBlock( String blockName, Material blockMaterial, float hardness,boolean opaque,int lo,String textureName){
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityItemsInvCable();
	}
	@Override
