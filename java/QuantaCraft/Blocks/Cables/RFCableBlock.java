...
public class RFCableBlock extends BlockContainer implements ICable{
	...
	public RFCableBlock( String blockName, Material blockMaterial, float hardness,boolean opaque,int lo,String textureName){
	...
	public boolean CanConnect(TileEntity ent) {
		...
		return (ent instanceof ICableRF || ent instanceof IEnergyHandler);
	}
}
