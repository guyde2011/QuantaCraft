...
public class TileEntityVoidPickStorage extends TileEntity implements ISidedInventory {


		public TileEntityVoidPickStorage() {
			super();
		}
        ...
        public void writeToNBT(NBTTagCompound tagCompound) { 
                ...
                public void updateEntity() {
                   ...
                   ItemStack stack = this.getStackInSlot(0);
                    ...
                    if (this.getStackInSlot(0)==null && this.storage>0){
                    	ItemStack a = storedItem;
