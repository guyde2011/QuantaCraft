...
public class ContainerVoidStorage extends Container {


	
    private TileEntityVoidStorage tileEntity;
    ...
    public ContainerVoidStorage (InventoryPlayer inventoryPlayer, TileEntityVoidStorage te){
            tileEntity = te;
