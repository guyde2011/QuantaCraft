...
public class ContainerDirectionalStorage extends Container {


	
    private TileEntityDirectionalStorage tileEntity;
    ...
    public ContainerDirectionalStorage (InventoryPlayer inventoryPlayer, TileEntityDirectionalStorage te){
            tileEntity = te;
