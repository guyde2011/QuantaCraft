...
public class ContainerAdamantiteContainer extends Container {


	
    private TileEntityAdamantiteContainer tileEntity;
    ...
    public ContainerAdamantiteContainer (InventoryPlayer inventoryPlayer, TileEntityAdamantiteContainer te){
            tileEntity = te;
