...
public class TileEntityHoloColorControl extends BasicHoloController{
	
	public String color;
	private boolean initialized;
	
	public TileEntityHoloColorControl(){
		super();
	}
	@Override
    ...
    public void readFromNBT(NBTTagCompound tagCompound) {
    	...
    	if (tagCompound.hasKey("colorText")){
    		this.color = tagCompound.getString("colorText");
    	}
    }
    ...
    public void writeToNBT(NBTTagCompound tagCompound) {
    	...
    	if (color!=null){
    		tagCompound.setString("colorText", color);
    	}
