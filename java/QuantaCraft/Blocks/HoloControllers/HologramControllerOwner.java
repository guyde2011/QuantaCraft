...
public class HologramControllerOwner extends BlockContainer implements IPickable{
	
	public TileEntityHoloOwnerControl hi;
	public EntityPlayer p;
	public HologramControllerOwner(int id, String name, Material blockMaterial, float hardness) {
		super(blockMaterial);
	...
	public void onBlockPlacedBy(World par1World, int x, int y, int z, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) {
        ...
        this.p = (EntityPlayer) par5EntityLivingBase;
        hi.owner = p.getDisplayName();
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float a, float b, float c)
    {
    	...
    	if ( player.getHeldItem()!=null && player.getHeldItem().getItem() == modMain.darkGem && (hi.owner==null || hi.owner.equals(player.getDisplayName()))){
	   ...
	   public void registerBlockIcons(IIconRegister icon) {
		   this.blockIcon = icon.registerIcon(modMain.modid.toLowerCase() + ":" +"ControllerSafe");
	   }

    @Override
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntityHoloOwnerControl();    
    	return hi;
    }
	...
	public EntityItem getEntityItem(int x, int y, int z, World world) {
        ...
        ItemStack item = new ItemStack(modMain.holoContOwner);
