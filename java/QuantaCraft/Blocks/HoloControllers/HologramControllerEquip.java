...
public class HologramControllerEquip extends BlockContainer implements IPickable{
	
	public TileEntityHoloEquipControl hi;
	public EntityPlayer p;
	public HologramControllerEquip(int id, String name, Material blockMaterial, float hardness) {
		super(blockMaterial);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float a, float b, float c)
    {
	   ...
	   public void registerBlockIcons(IIconRegister icon) {
		   this.blockIcon = icon.registerIcon(modMain.modid.toLowerCase() + ":" +"ControllerEquip");
	   }

    @Override
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntityHoloEquipControl();    
    	return hi;
    }
	...
	public EntityItem getEntityItem(int x, int y, int z, World world) {
        ...
        ItemStack item = new ItemStack(modMain.holoContEquip);
