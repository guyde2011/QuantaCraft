...
public class HologramControllerRedstone extends BlockContainer implements IPickable{
	
	public TileEntityHoloRedstoneControl hi;
	public EntityPlayer p;
	
	public HologramControllerRedstone(int id, String name, Material blockMaterial, float hardness) {
		super(blockMaterial);
    ...
    {
    	hi = (TileEntityHoloRedstoneControl) world.getTileEntity(x, y, z);
    ...
    private boolean isHex(String value) {
	   ...
	   public void registerBlockIcons(IIconRegister icon) {
		   this.blockIcon = icon.registerIcon(modMain.modid.toLowerCase() + ":" +"ControllerRedstone");
	   }

    @Override
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntityHoloRedstoneControl();    
    	return hi;
    }
	...
	public EntityItem getEntityItem(int x, int y, int z, World world) {
        ...
        ItemStack item = new ItemStack(modMain.holoContRedstone);
