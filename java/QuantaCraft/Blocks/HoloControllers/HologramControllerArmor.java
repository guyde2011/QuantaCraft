...
public class HologramControllerArmor extends BlockContainer implements IPickable{
	
	public TileEntityHoloArmorControl hi;
	public EntityPlayer p;
	public HologramControllerArmor(int id, String name, Material blockMaterial, float hardness) {
		super(blockMaterial);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float a, float b, float c)
    {
	   ...
	   public void registerBlockIcons(IIconRegister icon) {
		   this.blockIcon = icon.registerIcon(modMain.modid.toLowerCase() + ":" +"ControllerArmor");
	   }

    @Override
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntityHoloArmorControl();    
    	return hi;
    }
	...
	public EntityItem getEntityItem(int x , int y ,int z,World world) {
        ...
        ItemStack item = new ItemStack(modMain.holoContArmor);
