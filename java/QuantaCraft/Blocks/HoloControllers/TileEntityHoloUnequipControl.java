...
public class TileEntityHoloUnequipControl extends AdvancedHoloController{


	
	public boolean initialized;

	public TileEntityHoloUnequipControl(){
		super();
	}
	@Override
		...
		if (holo.getStackInSlot(0)==null){
			for (int i = 0; i<4;i++){
				if (player.inventory.armorInventory[i]!=null){
					holo.setInventorySlotContents(0, player.inventory.armorInventory[i]);
