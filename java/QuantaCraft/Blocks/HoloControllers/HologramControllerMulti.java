...
public class HologramControllerMulti extends BlockContainer implements IPickable{
	
	public TileEntityHoloMultiControl hi;
	public EntityPlayer p;
	
	public HologramControllerMulti(int id, String name, Material blockMaterial, float hardness) {
		super(blockMaterial);
    ...
    {
    	hi = (TileEntityHoloMultiControl) world.getTileEntity(x, y, z);
    ...
    private boolean isHex(String value) {
	   ...
	   public void registerBlockIcons(IIconRegister icon) {
		   this.blockIcon = icon.registerIcon(modMain.modid.toLowerCase() + ":" +"ControllerMulti");
	   }

    @Override
    public TileEntity createNewTileEntity(World world, int var2) {
    	this.hi=new TileEntityHoloMultiControl();    
    	return hi;
    }
