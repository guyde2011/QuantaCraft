...
public class TileEntityHoloTeleportControl extends AdvancedHoloController{
	...
	public TileEntityHoloTeleportControl(){
		super();
	}
	@Override
	...
	public String onPlayerWalkOn(TileEntityHologramStand holo, EntityPlayer player){
    	if (this.canTP){
    		player.setPositionAndUpdate(xCord, yCord, zCord);
    	}
		return "void";
    ...
    public void readFromNBT(NBTTagCompound tag) {
    	...
    	if (!tag.hasKey("xTP")){
    		canTP = false;
   	 		...
   	 		this.xCord = tag.getDouble("xTP");
   	 		this.yCord = tag.getDouble("yTP");
   	 		this.zCord = tag.getDouble("zTP");
    		canTP = true;
    	}
    }
    ...
    public void writeToNBT(NBTTagCompound tag) { 
    	...
    	if (canTP){
   	 		tag.setDouble("xTP",xCord);
   	 		tag.setDouble("yTP",yCord);
   	 		tag.setDouble("zTP",zCord);
    	}
    }
