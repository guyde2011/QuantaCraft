...
public class VoidStorageGui extends GuiContainer {
    	public int guiX = 256;
    	private TileEntityVoidStorage myMachine;
    	public int guiY = 256;
        public VoidStorageGui (InventoryPlayer inventoryPlayer,
                        TileEntityVoidStorage tileEntity) {
                //the container is instanciated and passed to the superclass for handling
                super(new ContainerVoidStorage(inventoryPlayer, tileEntity));
        ...
        protected void drawGuiContainerBackgroundLayer(float par1, int par2,
                        int par3) {
        	    ResourceLocation res = new ResourceLocation("quantacraft:textures/gui/VoidStorageUnit.png");
